...
mod tests {
    ...
    fn disp_ninth() {
        ...
        for places in [3, 17, 123, 4567] {
            ...
            assert!(
                check_ninth(&formatted, places),
                "{formatted} was not formatted as expected to {places} decimal places"
            );
        }
    }
    ...
    fn disp_pi() {
        ...
        assert_eq!(
            format!("{pi:.3062}"),
            "3."
        );
    }
